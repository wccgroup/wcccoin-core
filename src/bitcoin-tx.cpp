...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s wcccoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  wcccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wcccoin transaction") + "\n" +
              "  wcccoin-tx [options] -create [commands]   " + _("Create hex-encoded wcccoin transaction") + "\n" +
              "\n";
