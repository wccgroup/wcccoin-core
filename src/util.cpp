...
const char * const BITCOIN_CONF_FILENAME = "wcccoin.conf";
const char * const BITCOIN_PID_FILENAME = "wcccoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Wcccoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Wcccoin";
#else
    // Unix
    return pathRet / ".wcccoin";
#endif
#endif
}
