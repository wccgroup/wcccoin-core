...
#if defined(NDEBUG)
# error "Wcccoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Wcccoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s WCC additional fees, %d delta bytes\n",
