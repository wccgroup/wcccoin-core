Wcccoin Core version *0.15.1* is now available from:

  <https://download.wcccoin.org/wcccoin-0.15.1/>
...
A number of changes to the way Wcccoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 microwccs per kB (0.00001 WCC). This is to prepare for dropping the minimum transaction fee to 0.1 microwccs per kB (0.0001 WCC) in the next release.
